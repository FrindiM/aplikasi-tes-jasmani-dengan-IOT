                     ...
                     <tbody>
                         <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                             <tr>
                                 ...
                                 <td>
                                     <button class="btn btn-primary mb-2" type="submit" name="simpan2">Edit</button>
                                     </form>
                                     <form method="POST" action="ledit.php">
                                         <input type="hidden" name="tag_id" value="<?= $row['tag_id'] ?>">
                                         <button class="btn btn-danger" type="submit" name="reset2">Reset</button>
                                     </form>
                                 </td>
                             </tr>
                         <?php } ?>
