...
$query = "SELECT * FROM tag_id2 WHERE tag_id = '$tag_id'";
$result = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($result);

// ambil data dari tabel sensordata
$query_sensordata = "SELECT * FROM sensordata2 WHERE tag = '$tag_id' ORDER BY reading_time DESC";
...
<div class="container">
    ...
    <a class="btn btn-primary mt-3" href="unduhdetails.php?tag_id=<?php echo $tag_id; ?>">Unduh Laporan</a>
</div>
<?php
